...
const PINCODES_DATA_PATH = path.resolve(__dirname, `${relativePath}/config/database/statics/pincodes.json`);
const STATES_DATA_PATH = path.resolve(__dirname, `${relativePath}/config/database/statics/states.json`);
